...
def send_reminder(debtor_id):
    ...
    for debt in detailed_breakdown:
        ...
        if (debt["from"] == debtor.email or 
            (debtor.display_name and debt["from"] == debtor.display_name)) and \
           (debt["to"] == creditor.email or 
            (creditor.display_name and debt["to"] == creditor.display_name)):
